...
object MathUtils {
   ...
   */
  def mix(t: Double, a: Double, b: Double): Double = {
    a * (1.0 - t) + b * t
  }
   ...
   */
  def clamp(value: Double, start: Double, end: Double): Double = {
   ...
   */
  def clampZeroToOne(value: Double): Double = {
    if (value < 0) 0
    else if (value > 1) 1
    else value
  }
   ...
   */
  def clampMinusOneToOne(value: Double): Double = {
    if (value < -1) -1
    else if (value > 1) 1
    else value
  }
  ...
  /* TODO
  / **
   * Roll a value to be in the specified range.
   * /
  def roll(value: Double, start: Double, end: Double): Double = {
  }
  */
